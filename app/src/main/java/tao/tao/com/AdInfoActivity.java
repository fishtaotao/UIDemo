...
import tao.tao.adpater.SpinnerAdapter;
import tao.tao.model.DataBean;

/**
 * Author：wjt on 2018/4/23 0023 15:20
 */
...
public class AdInfoActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.adinfo_activity);
    ...
    private void initView() {
        ...
        SpinnerAdapter spinnerAdapter = new SpinnerAdapter(mList, AdInfoActivity.this);
    ...
    private void initListener() {
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parent, View view, int position, long id) {
                AdManager adManager = new AdManager(AdInfoActivity.this, advList);
        ...
        button1.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(result)) {
                    Toast.makeText(AdInfoActivity.this, "请输入弹出动画的角度!", Toast.LENGTH_SHORT).show();
                    return;
                }
                ...
                adManager.setOnImageClickListener(new AdManager.OnImageClickListener() {
                    ...
                    public void onImageClick(View view, AdInfo advInfo) {
                        Toast.makeText(AdInfoActivity.this, "您点击了ViewPagerItem...", Toast.LENGTH_SHORT).show();
                    }
                });
