...
/**
 * Author：wjt on 2018/6/4 0004 19:42
 */

public class Easyswipemenulayout  extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.easyswipemenulayout);
        initIView();
        initIEvent();
        initIData();
    }
        ...
        protected void convert(final BaseViewHolder helper, String item) {
            ...
            helper.getView(R.id.right_menu_2).setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    Toast.makeText(Easyswipemenulayout.this, "收藏", Toast.LENGTH_SHORT).show();
            ...
            helper.getView(R.id.content).setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    Toast.makeText(Easyswipemenulayout.this, "setOnClickListener", Toast.LENGTH_SHORT).show();
