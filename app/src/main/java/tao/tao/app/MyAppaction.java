...
/**
 * Author：wjt on 2018/6/12 0012 14:43
 */

public class MyAppaction extends BaseApplication {

    private static MyAppaction sInstance;

    public static MyAppaction getInstance() {
        return sInstance;
    }
